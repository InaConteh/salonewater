...
export const apiClient = {
  ...
  getMaintenanceLog: (id: string) => api.get<MaintenanceLog>(`/maintenance/${id}`),

  createMaintenanceLog: (payload: Partial<MaintenanceLog>) =>
    api.post<MaintenanceLog>('/maintenance', payload),

  updateMaintenanceLog: (id: string, payload: Partial<MaintenanceLog>) =>
