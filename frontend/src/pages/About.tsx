          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                Salone Water Watch solves this by connecting communities, water committees, and district partners
            ...
            <div className="relative">
              <div className="aspect-[4/5] rounded-[3rem] overflow-hidden shadow-2xl relative">
                ...
                <div className="absolute bottom-8 left-8 right-8 text-white">
                  <p className="text-2xl font-bold italic mb-2">"Salone Water Watch has transformed how we respond to pump failures in Kambia."</p>
        ...
        <div className="page-container text-center">
          ...
          <div className="max-w-3xl mx-auto mb-12">
            <p className="text-lg text-muted-foreground mb-8">
              Salone Water Watch is an open-source initiative dedicated to improving public health infrastructure.
